...
completeptPrefix = '~/PermTest/timings/TwoSample_ADRC_50_50_100/regularpt/timings_100_';
completeptPostfix = '.mat';
rapidptPrefix1 = '~/PermTest/timings/TwoSample_ADRC_50_50_100/rapidpt/';
rapidptPostfix = '.mat';

N = 100;
permutations = [5000 10000 20000 40000 80000 160000 320000]; 
...
for i = 1:numPermRuns
    ...
    f = PlotSpeedup(subSamplings, trainSamples, numPermutations, speedups',[1,1.5]);
%     filename = strcat(path,'FirstSet_Speedups_',numPermutations);
