...
function [ outputs ] = TwoSampleRapidPermutationTesting( inputs )
...
%% Training for low rank subsapace and residual priors
    ...
    [dummyMaxT, TCurrent] = TwoSamplePermTest(data, dataSquared, permutationMatrix1Current, permutationMatrix2Current, nGroup1, nGroup2, maxMemory );
